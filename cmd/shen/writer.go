...
tmp2082 := Call(__e, PrimFunc(sympr), W5624, tmp2081)
...
tmp2083 := Call(__e, PrimFunc(symshen_4insert), V5623, MakeString("~S"))
...
tmp2088 := Call(__e, PrimFunc(symshen_4char_1stoutput_2), V5627)


if True == tmp2088 {
__e.TailApply(PrimFunc(symshen_4write_1string), V5626, V5627)
return
} else {
tmp2086 := Call(__e, PrimFunc(symshen_4string_1_6byte), V5626, MakeNumber(0))


__e.TailApply(PrimFunc(symshen_4write_1chars), V5626, V5627, tmp2086, MakeNumber(1))
return
...
V5634 := __e.Get(4)
_ = V5634
tmp2102 := PrimEqual(symshen_4eos, V5633)

if True == tmp2102 {
__e.Return(V5631)
return
} else {
tmp2098 := PrimWriteByte(V5633, V5632)

_ = tmp2098

tmp2099 := Call(__e, PrimFunc(symshen_4string_1_6byte), V5631, V5634)


tmp2100 := PrimNumberAdd(V5634, MakeNumber(1))

__e.TailApply(PrimFunc(symshen_4write_1chars), V5631, V5632, tmp2099, tmp2100)
return
...
V5636 := __e.Get(2)
_ = V5636
tmp2109 := PrimIsString(V5635)

if True == tmp2109 {
tmp2105 := Call(__e, PrimFunc(symshen_4proc_1nl), V5635)


__e.TailApply(PrimFunc(symshen_4mkstr_1l), tmp2105, V5636)
return


} else {
tmp2106 := PrimCons(V5635, Nil)

tmp2107 := PrimCons(symshen_4proc_1nl, tmp2106)

__e.TailApply(PrimFunc(symshen_4mkstr_1r), tmp2107, V5636)
return
...
V5642 := __e.Get(2)
_ = V5642
tmp2118 := PrimEqual(Nil, V5642)

if True == tmp2118 {
__e.Return(V5641)
return
} else {
tmp2116 := PrimIsPair(V5642)

if True == tmp2116 {
tmp2112 := PrimHead(V5642)

tmp2113 := Call(__e, PrimFunc(symshen_4insert_1l), tmp2112, V5641)


tmp2114 := PrimTail(V5642)
...
V5650 := __e.Get(2)
_ = V5650
tmp2258 := PrimEqual(MakeString(""), V5650)

if True == tmp2258 {
__e.Return(MakeString(""))
return
} else {
tmp2256 := Call(__e, PrimFunc(symshen_4_7string_2), V5650)


var ifres2243 Obj

if True == tmp2256 {
tmp2254 := Call(__e, PrimFunc(symhdstr), V5650)
...
tmp2125 := PrimCons(V5649, tmp2124)
...
tmp2241 := Call(__e, PrimFunc(symshen_4_7string_2), V5650)


var ifres2228 Obj

if True == tmp2241 {
tmp2239 := Call(__e, PrimFunc(symhdstr), V5650)
...
tmp2130 := PrimCons(V5649, tmp2129)
...
tmp2226 := Call(__e, PrimFunc(symshen_4_7string_2), V5650)


var ifres2213 Obj

if True == tmp2226 {
tmp2224 := Call(__e, PrimFunc(symhdstr), V5650)
...
tmp2135 := PrimCons(V5649, tmp2134)
...
tmp2211 := Call(__e, PrimFunc(symshen_4_7string_2), V5650)


if True == tmp2211 {
tmp2136 := Call(__e, PrimFunc(symhdstr), V5650)


tmp2137 := PrimTailString(V5650)

tmp2138 := Call(__e, PrimFunc(symshen_4insert_1l), V5649, tmp2137)
...
tmp2209 := PrimIsPair(V5650)

var ifres2190 Obj

if True == tmp2209 {
tmp2207 := PrimHead(V5650)
...
if True == ifres2190 {
tmp2142 := PrimTail(V5650)

tmp2143 := PrimHead(tmp2142)

tmp2144 := PrimTail(V5650)

tmp2145 := PrimTail(tmp2144)

tmp2146 := PrimHead(tmp2145)

tmp2147 := Call(__e, PrimFunc(symshen_4insert_1l), V5649, tmp2146)
...
tmp2188 := PrimIsPair(V5650)

var ifres2162 Obj

if True == tmp2188 {
tmp2186 := PrimHead(V5650)
...
if True == ifres2162 {
tmp2150 := PrimTail(V5650)

tmp2151 := PrimHead(tmp2150)

tmp2152 := PrimTail(V5650)

tmp2153 := PrimTail(tmp2152)

tmp2154 := PrimHead(tmp2153)

tmp2155 := Call(__e, PrimFunc(symshen_4insert_1l), V5649, tmp2154)


tmp2156 := PrimTail(V5650)
...
V5651 := __e.Get(1)
_ = V5651
tmp2345 := PrimIsPair(V5651)

var ifres2276 Obj

if True == tmp2345 {
tmp2343 := PrimHead(V5651)
...
if True == ifres2276 {
tmp2261 := PrimTail(V5651)

tmp2262 := PrimHead(tmp2261)

tmp2263 := PrimTail(V5651)
...
V5654 := __e.Get(1)
_ = V5654
tmp2373 := PrimEqual(MakeString(""), V5654)

if True == tmp2373 {
__e.Return(MakeString(""))
return
} else {
tmp2371 := Call(__e, PrimFunc(symshen_4_7string_2), V5654)


var ifres2358 Obj

if True == tmp2371 {
tmp2369 := Call(__e, PrimFunc(symhdstr), V5654)
...
tmp2356 := Call(__e, PrimFunc(symshen_4_7string_2), V5654)


if True == tmp2356 {
tmp2352 := Call(__e, PrimFunc(symhdstr), V5654)


tmp2353 := PrimTailString(V5654)
...
V5660 := __e.Get(2)
_ = V5660
tmp2384 := PrimEqual(Nil, V5660)

if True == tmp2384 {
__e.Return(V5659)
return
} else {
tmp2382 := PrimIsPair(V5660)

if True == tmp2382 {
tmp2376 := PrimHead(V5660)

tmp2377 := PrimCons(V5659, Nil)

tmp2378 := PrimCons(tmp2376, tmp2377)

tmp2379 := PrimCons(symshen_4insert, tmp2378)

tmp2380 := PrimTail(V5660)
...
V5662 := __e.Get(2)
_ = V5662
__e.TailApply(PrimFunc(symshen_4insert_1h), V5661, V5662, MakeString(""))
return
}, 2)
...
V5673 := __e.Get(3)
_ = V5673
tmp2449 := PrimEqual(MakeString(""), V5672)

if True == tmp2449 {
__e.Return(V5673)
return
} else {
tmp2447 := Call(__e, PrimFunc(symshen_4_7string_2), V5672)


var ifres2434 Obj

if True == tmp2447 {
tmp2445 := Call(__e, PrimFunc(symhdstr), V5672)
...
if True == ifres2434 {
tmp2389 := PrimTailString(V5672)

tmp2390 := PrimTailString(tmp2389)

tmp2391 := Call(__e, PrimFunc(symshen_4app), V5671, tmp2390, symshen_4a)


__e.Return(PrimStringConcat(V5673, tmp2391))
return


} else {
tmp2432 := Call(__e, PrimFunc(symshen_4_7string_2), V5672)


var ifres2419 Obj

if True == tmp2432 {
tmp2430 := Call(__e, PrimFunc(symhdstr), V5672)
...
if True == ifres2419 {
tmp2392 := PrimTailString(V5672)

tmp2393 := PrimTailString(tmp2392)

tmp2394 := Call(__e, PrimFunc(symshen_4app), V5671, tmp2393, symshen_4r)


__e.Return(PrimStringConcat(V5673, tmp2394))
return


} else {
tmp2417 := Call(__e, PrimFunc(symshen_4_7string_2), V5672)


var ifres2404 Obj

if True == tmp2417 {
tmp2415 := Call(__e, PrimFunc(symhdstr), V5672)
...
if True == ifres2404 {
tmp2395 := PrimTailString(V5672)

tmp2396 := PrimTailString(tmp2395)

tmp2397 := Call(__e, PrimFunc(symshen_4app), V5671, tmp2396, symshen_4s)


__e.Return(PrimStringConcat(V5673, tmp2397))
return


} else {
tmp2402 := Call(__e, PrimFunc(symshen_4_7string_2), V5672)


if True == tmp2402 {
tmp2398 := PrimTailString(V5672)

tmp2399 := Call(__e, PrimFunc(symhdstr), V5672)


tmp2400 := PrimStringConcat(V5673, tmp2399)

__e.TailApply(PrimFunc(symshen_4insert_1h), V5671, tmp2398, tmp2400)
return
...
V5676 := __e.Get(3)
_ = V5676
tmp2452 := Call(__e, PrimFunc(symshen_4arg_1_6str), V5674, V5676)


__e.Return(PrimStringConcat(tmp2452, V5675))
return
...
tmp2463 := PrimEqual(V5680, tmp2462)

if True == tmp2463 {
__e.Return(MakeString("..."))
return
} else {
tmp2460 := Call(__e, PrimFunc(symshen_4list_2), V5680)


if True == tmp2460 {
__e.TailApply(PrimFunc(symshen_4list_1_6str), V5680, V5681)
return
} else {
tmp2458 := PrimIsString(V5680)

if True == tmp2458 {
__e.TailApply(PrimFunc(symshen_4str_1_6str), V5680, V5681)
return
} else {
tmp2456 := PrimIsVector(V5680)

if True == tmp2456 {
__e.TailApply(PrimFunc(symshen_4vector_1_6str), V5680, V5681)
return
} else {
__e.TailApply(PrimFunc(symshen_4atom_1_6str), V5680)
return
}
...
V5683 := __e.Get(2)
_ = V5683
tmp2473 := PrimEqual(symshen_4r, V5683)

if True == tmp2473 {
tmp2466 := Call(__e, PrimFunc(symshen_4maxseq))


tmp2467 := Call(__e, PrimFunc(symshen_4iter_1list), V5682, symshen_4r, tmp2466)
...
tmp2470 := Call(__e, PrimFunc(symshen_4iter_1list), V5682, V5683, tmp2469)
...
V5696 := __e.Get(3)
_ = V5696
tmp2498 := PrimEqual(Nil, V5694)

if True == tmp2498 {
__e.Return(MakeString(""))
return
} else {
tmp2496 := PrimEqual(MakeNumber(0), V5696)

if True == tmp2496 {
__e.Return(MakeString("... etc"))
return
} else {
tmp2494 := PrimIsPair(V5694)

var ifres2490 Obj

if True == tmp2494 {
tmp2492 := PrimTail(V5694)
...
if True == ifres2490 {
tmp2478 := PrimHead(V5694)

__e.TailApply(PrimFunc(symshen_4arg_1_6str), tmp2478, V5695)
return


} else {
tmp2488 := PrimIsPair(V5694)

if True == tmp2488 {
tmp2479 := PrimHead(V5694)

tmp2480 := Call(__e, PrimFunc(symshen_4arg_1_6str), tmp2479, V5695)


tmp2481 := PrimTail(V5694)

tmp2482 := PrimNumberSubtract(V5696, MakeNumber(1))

tmp2483 := Call(__e, PrimFunc(symshen_4iter_1list), tmp2481, V5695, tmp2482)
...
tmp2485 := Call(__e, PrimFunc(symshen_4arg_1_6str), V5694, V5695)
...
V5700 := __e.Get(2)
_ = V5700
tmp2505 := PrimEqual(symshen_4a, V5700)
...
tmp2503 := Call(__e, PrimFunc(sym_8s), V5699, tmp2502)
...
V5702 := __e.Get(2)
_ = V5702
tmp2520 := Call(__e, PrimFunc(symshen_4print_1vector_2), V5701)


if True == tmp2520 {
tmp2508 := PrimVectorGet(V5701, MakeNumber(0))

tmp2509 := Call(__e, PrimFunc(symfn), tmp2508)


__e.TailApply(tmp2509, V5701)
return


} else {
tmp2518 := Call(__e, PrimFunc(symvector_2), V5701)
...
tmp2511 := Call(__e, PrimFunc(symshen_4iter_1vector), V5701, MakeNumber(1), V5702, tmp2510)
...
tmp2514 := Call(__e, PrimFunc(symshen_4iter_1vector), V5701, MakeNumber(0), V5702, tmp2513)
...
W5704 := __e.Get(1)
_ = W5704
tmp2530 := PrimEqual(W5704, symshen_4tuple)

if True == tmp2530 {
__e.Return(True)
return
} else {
tmp2528 := PrimEqual(W5704, symshen_4pvar)

if True == tmp2528 {
__e.Return(True)
return
} else {
tmp2525 := PrimIsNumber(W5704)

tmp2526 := PrimNot(tmp2525)

if True == tmp2526 {
__e.TailApply(PrimFunc(symshen_4fbound_2), W5704)
return
} else {
__e.Return(False)
return
...
tmp2531 := PrimVectorGet(V5703, MakeNumber(0))
...
V5705 := __e.Get(1)
_ = V5705
tmp2534 := Call(__e, PrimFunc(symarity), V5705)
...
V5706 := __e.Get(1)
_ = V5706
tmp2538 := PrimVectorGet(V5706, MakeNumber(1))

tmp2539 := PrimVectorGet(V5706, MakeNumber(2))
...
V5716 := __e.Get(4)
_ = V5716
tmp2564 := PrimEqual(MakeNumber(0), V5716)
...
W5719 := __e.Get(1)
_ = W5719
tmp2555 := PrimEqual(W5717, symshen_4out_1of_1bounds)

if True == tmp2555 {
__e.Return(MakeString(""))
return
} else {
tmp2553 := PrimEqual(W5719, symshen_4out_1of_1bounds)

if True == tmp2553 {
__e.TailApply(PrimFunc(symshen_4arg_1_6str), W5717, V5715)
return
} else {
tmp2547 := Call(__e, PrimFunc(symshen_4arg_1_6str), W5717, V5715)


tmp2548 := PrimNumberAdd(V5714, MakeNumber(1))

tmp2549 := PrimNumberSubtract(V5716, MakeNumber(1))

tmp2550 := Call(__e, PrimFunc(symshen_4iter_1vector), V5713, tmp2548, V5715, tmp2549)
...
tmp2557 := PrimNumberAdd(V5714, MakeNumber(1))

__e.Return(PrimVectorGet(V5713, tmp2557))
return
...
__e.Return(PrimVectorGet(V5713, V5714))
return
}, 0)
...
V5723 := __e.Get(1)
_ = V5723
tmp2584 := Call(__e, PrimFunc(symempty_2), V5723)
